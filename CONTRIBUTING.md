...
Use `just dev` for the desktop app, `just dev-cli --help` for the CLI, and `just dev-docs` for documentation. Code and code comments are written in English. User-facing documentation is maintained in matching `docs/en` and `docs/zh` files.
