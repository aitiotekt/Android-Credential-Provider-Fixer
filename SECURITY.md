...
Version `0.1.0-alpha.1` is an engineering baseline and cannot execute ADB operations. Security-sensitive device modification remains out of scope until the snapshot, plan, verification, and recovery design is implemented and tested.
